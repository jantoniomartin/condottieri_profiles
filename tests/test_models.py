...
class CondottieriProfileTestCase(TestCase):
	...
	def test_has_languages(self):
		...
		user_0.get_profile().spokenlanguage_set.create(code='en')
		self.assertTrue(user_0.get_profile().has_languages())
		self.assertFalse(user_1.get_profile().has_languages())

	def test_average_score(self):
		user_0 = User.objects.get(username="user_0")
		prof = user_0.get_profile()
	...
	def test_create_profile(self):
		...
		self.assertIsInstance(user_2.get_profile(), CondottieriProfile)
