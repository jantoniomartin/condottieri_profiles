    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('friend_from', models.ForeignKey(related_name='friends', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
                ('friend_to', models.ForeignKey(related_name='friend_of', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
        ),
        migrations.CreateModel(
            name='SpokenLanguage',
            fields=[
                ...
                ('profile', models.ForeignKey(to='condottieri_profiles.CondottieriProfile', on_delete=models.CASCADE)),
            ],
        ),
